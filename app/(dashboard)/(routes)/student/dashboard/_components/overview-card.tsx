...
const OverviewCard = ({ title, value, icon: Icon, totalCourses, completedCourses }: Props) => {
    return (
        <article className="shadow-md p-4 rounded-xl flex items-center justify-between gap-x-4">
