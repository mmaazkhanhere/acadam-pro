...
const ChapterDescriptionForm = ({ initialDescription, chapterId, courseId }: Props) => {
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-x-2 text-sm">
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle>Edit Chapter Description</AlertDialogTitle>
                            </AlertDialogHeader>
            ...
            <p className="text-sm text-gray-600">
                {
                    !initialDescription ? 'No description' : <EditorPreview
